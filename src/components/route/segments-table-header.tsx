  ...
  return (
    <TableHeader>
      <TableRow className="border-primary-200 dark:border-mountain-700">
        ...
        <TableHead className="text-mountain-700 dark:text-mountain-300">Gradiente</TableHead>
        {isAdvancedMode && <TableHead className="text-mountain-700 dark:text-mountain-300">Calidad</TableHead>}
      </TableRow>
    </TableHeader>
  );
};
